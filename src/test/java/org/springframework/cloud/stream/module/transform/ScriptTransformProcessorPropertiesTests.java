...
import org.python.netty.channel.ChannelOutboundBuffer.MessageProcessor;
 ...
 * @author Andy Clement
 */
public class ScriptTransformProcessorPropertiesTests {
...
//		this.thrown.expectMessage("Field error in object 'target' on field 'query': rejected value [null]");
		EnvironmentTestUtils.addEnvironment(this.context, "script:foo");
		this.context.register(Conf.class);
		this.context.refresh();
		this.context.getBean(MessageProcessor.class);
	}
